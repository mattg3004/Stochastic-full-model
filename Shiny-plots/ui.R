...
shinyUI(fluidPage(
  ...
  mainPanel(googleBubbleChart("chart",
                              ...
                              options = list(
                                ...
                                colorAxis = list(
                                  colors = c('firebrick', 'red','orange', 'gold', 'palegreen', 'darkgreen'),
                                  colors = c('firebrick', 'red', 'yellow', 'skyblue', 'blue')
                                ),
                                sizeAxis = list(minValue = 0,  maxSize = 22),
  ...
  shiny::column(2, offset = 4,
                sliderInput(inputId = "year", 
                            ...
                            min = min(anim.data$Year), max = max(anim.data$Year), step = 0.1, format = "####",
                            value = min(anim.data$Year), 
                            width = '200%',
